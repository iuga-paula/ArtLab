...
// WP-Optimize advanced-cache.php (written by version: 3.1.7) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/home/vol7_7/unaux.com/unaux_28077790/htdocs/wp-content/plugins/wp-optimize/cache',
);
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/home/vol7_7/unaux.com/unaux_28077790/htdocs/wp-content/plugins/wp-optimize/cache/extensions');
}

if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-artlab.unaux.com.php')) { return; }

$GLOBALS['wpo_cache_config'] = @json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-artlab.unaux.com.php'), true);

if (empty($GLOBALS['wpo_cache_config'])) {
	include_once(WPO_CACHE_CONFIG_DIR . '/config-artlab.unaux.com.php');
}
